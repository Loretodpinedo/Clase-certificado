...
public class Colecciones {
    ...
    //Creacion array de String
		...
		//y lo siguiente 2ª parte la lista que queremos recorrer. 
		...
		//dos maneras de crear un objeto integer.
			...
			//para el resto de tipos de dato se pone el nombre del dato con la 1º letra mayuscula.
			...
			mapaUsuarioContrasenia.put("Pepe", "2468");//Cambio la contraseña de Pepe.
