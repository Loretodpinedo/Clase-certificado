...
public class MainLibreria {
	...
	public static void main(String[] args) {
		...
		/*
		 * Esto podriamos hacerlo si quisieramos tener varias librerias Libreria l2 =
		 * new Libreria(); ArrayList<Libro> listaLibros2 = new ArrayList<Libro>();
		 * l2.setListaLibros(listaLibros2);
		 * 
		 * Libreria l3 = new Libreria(); ArrayList<Libro> listaLibros3 = new
		 * ArrayList<Libro>(); l2.setListaLibros(listaLibros2);
		 * 
		 * Libreria l4 = new Libreria(); ArrayList<Libro> listaLibros4 = new
		 * ArrayList<Libro>(); l2.setListaLibros(listaLibros4);
		 * 
		 * //si queremos hacer esto debemos de tener el setter gl.setLibreria(l4);
		 */
		String opcion = "0";
		do {
