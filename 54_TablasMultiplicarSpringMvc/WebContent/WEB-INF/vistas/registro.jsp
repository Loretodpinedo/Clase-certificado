...
<body background="http://localhost:8080/54_TablasMultiplicarSpringMvc/numbers.jpg">
...
<h1
	...
	<form action="ControladorTabla" style="text-align: center;font-size: 25px">
		<font color= black size="5">Usuario</font><br/><input type="text"
			name="User" placeholder="Inserte el nombre de usuario"
			required="required" /> 
			<br /> 
		<font color= black size="5">Password</font><br/><input
